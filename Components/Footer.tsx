...
const Footer = () => {
  return (
    <div className="footer bg-black w-full flex flex-col md:flex-row items-center justify-center md:justify-between min-h-[400px] md:min-h-[489px] p-4 md:p-10 shadow-inner">
