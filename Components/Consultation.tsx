...
const Consultation = () => {
  return (
    <div className="text-center flex flex-col justify-center items-center min-h-[400px]">
      ...
      <button className="bg-white/15 backdrop-blur-md border border-white/30 text-white rounded-4xl py-3 px-2 w-[204px] h-[52px] shadow-lg hover:bg-white/25 transition"><span className="text-[14px]">Book A consultation</span></button>
    </div>
  );
};
